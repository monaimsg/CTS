...
<head>
    <title>Reserve laundromat</title>
...
<body>
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <h2 class="mb-4">My laundromat reservations</h2>
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col"></th>
                        <th scope="col">name laundromat</th>
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM `laundromat_reserve` WHERE `user` =  " . $_SESSION['user']['id'] . " ORDER BY `date` DESC";
                    ...
                    if (!$result) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            $sq = "SELECT * FROM `laundromat` WHERE `id` = " . $row['laundromat'] . "";
